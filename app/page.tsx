...
import { getArticles, getProjects } from '@/lib/obsidian'
...
export default async function HomePage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="order-2 lg:order-1">
            <h1 className="mb-6 text-4xl font-bold sm:text-5xl xl:text-6xl">
              Hi, I'm <span className="gradient-brand-text">Tom French</span>
            </h1>
            ...
            <p className="mb-6 max-w-lg text-lg text-secondary">
              ...
              Previously CPO at Utility Warehouse (FTSE 250) and Alfred. Founded BrightSun (exited).
            </p>

            {/* Social Links */}
            <div className="flex gap-4">
              <a
                href="https://linkedin.com/in/tomfrench"
                target="_blank"
              ...
              <a
                href="https://github.com/tomfrench"
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl p-3 transition-all hover:shadow-md"
                style={{backgroundColor: 'var(--hover-bg)', color: 'var(--text-secondary)'}}
              ...
              <a
                href="https://twitter.com/tomfrench"
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl p-3 transition-all hover:shadow-md"
                style={{backgroundColor: 'var(--hover-bg)', color: 'var(--text-secondary)'}}
          ...
          <div className="order-1 flex justify-center lg:order-2 lg:justify-end">
            <div className="relative h-80 w-80 overflow-hidden rounded-full gradient-brand p-1.5 shadow-2xl lg:h-96 lg:w-96">
              <div className="h-full w-full rounded-full" style={{backgroundColor: 'var(--background)'}}>
                {/* Placeholder for profile image */}
                <div className="flex h-full items-center justify-center">
                  <span className="gradient-brand-text text-8xl font-bold lg:text-9xl">TF</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Ideas I'm Exploring Section */}
      <section className="mb-20">
        <h2 className="mb-10 text-3xl font-bold sm:text-4xl">Ideas I'm exploring</h2>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex items-start gap-4 rounded-2xl p-2">
            <div className="mt-1 h-2 w-2 rounded-full bg-blue-500"></div>
            <div>
              <h3 className="mb-2 text-lg font-semibold">AI-Native Product Development</h3>
              <p className="text-secondary">How teams can integrate AI into every stage of the product lifecycle</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 rounded-2xl p-2">
            ...
            <div>
              <h3 className="mb-2 text-lg font-semibold">Remote Team Dynamics</h3>
              <p className="text-secondary">Building high-trust, high-performance distributed product teams</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 rounded-2xl p-2">
            ...
            <div>
              <h3 className="mb-2 text-lg font-semibold">Sustainable Growth Models</h3>
              <p className="text-secondary">Balancing rapid scaling with long-term organizational health</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 rounded-2xl p-2">
            ...
            <div>
              <h3 className="mb-2 text-lg font-semibold">Data-Driven Decision Making</h3>
              <p className="text-secondary">Moving beyond vanity metrics to actionable product insights</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 rounded-2xl p-2">
            ...
            <div>
              <h3 className="mb-2 text-lg font-semibold">Customer-Centric Innovation</h3>
              <p className="text-secondary">Systematic approaches to understanding and solving real customer problems</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 rounded-2xl p-2">
            ...
            <div>
              <h3 className="mb-2 text-lg font-semibold">Platform Strategy</h3>
              <p className="text-secondary">Building scalable product platforms that enable rapid feature development</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-16 lg:grid-cols-2">
          ...
          <div>
            <div className="mb-8 flex items-center justify-between">
              <h2 className="text-2xl font-bold sm:text-3xl">Recent articles</h2>
              <Link 
                href="/articles" 
      ...
      <section className="mb-20">
        <h2 className="mb-10 text-3xl font-bold sm:text-4xl">Featured projects</h2>
        ...
        <div className="mt-8 text-center">
          <Link 
            href="/projects" 
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-3 text-white font-medium transition-all hover:shadow-lg hover:scale-105"
          >
            View all projects
